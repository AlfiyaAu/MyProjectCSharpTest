...
{
    /// <inheritdoc />
    public partial class _000_New_InitialMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Percent1 = table.Column<double>(type: "float", nullable: false),
                    Percent2 = table.Column<double>(type: "float", nullable: false),
                    Percent3 = table.Column<double>(type: "float", nullable: false),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSelfTypes", x => x.IdUser);
                });
